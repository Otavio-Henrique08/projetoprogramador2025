...
--DDL _ Linguagem d deinição de dados 
...
--ALTERANDO A TABELA, adicionando coluna e idade 
...
INSERT INTO cidade(nome, cep, estado, id-regiao-fk0) VALUES
...
CREATE TABLE ponto_focal (
    ...
    email VARCHAR(45),
    id_cidade_fk INT,
    FOREIGN KEY (id_cidade_fk) REFERENCES cidades(id)
);
...
('Assistência Social', 'Assistencia LTDA', 'Publica', '11-222-333/0001-01', 'Av. Central, 456', '(44)4002-8922', '(44)98844-5623', 'assistencia@gmail.com', 2);
